...
sql_profile = (
    f"select * from aggcombatprofile where metabatchid  in ("
    + ",".join(bq)
    + ")"
)
...
# df_num_cpd["meta_efficacy"] = df_cpds_merge["efficacy"].apply(
#     lambda x: x.split(",")[0]
# )
df_num_cpd["meta_target"] = df_cpds_merge["geneid"]+'_'+df_cpds_merge['keggid']
