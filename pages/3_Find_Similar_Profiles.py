...
if "df_profiles" not in st.session_state:
    ...
    with knn_sim_tab:  # Similar CPDs with UMAP
        ...
        if choix in df_src_emd["metacpdname"].values: 
            ...
            df_keep_prof_cpd_knn = df_keep_prof_cpd_knn.merge(knn_sim_df[["metabatchid","metaefficacy","metageneid","metagenesymbol","metasmile","metakeggid","metacpdname"]], left_on='metabatchid', right_on='metabatchid').reset_index(drop=True)
